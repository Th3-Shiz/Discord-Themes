 ...
 * @name Th3-Shizified 
 * @author Th3-Shiz
 * @description Th3-shizes 1st full made theme
 * @version 1
 */
* {
	font-family: Godofwar !important;
}
...
.tutorialIcon-3f1miQ {
	background: linear-gradient(5deg, transparent 52%, rgba(243, 4, 136, 0.8) 100%);
	border: 2px solid rgba(187, 1, 224, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(142, 9, 231, 0.966);
	background-color: rgba(37, 22, 34, 0.701);
	border-radius: 30px;
}
.groupStart-23k01U{
    display: none;
...
.selectorButton-EEUWed {
  background-color: rgba(229, 204, 246, 0.3);
}
...
.selectorButton-EEUWed:not(.selectorButtonPremiumRequired-mKMbIu):hover {
  background-color: rgba(204, 227, 246, .6);
}

.card-2Mz_4z {
	background: linear-gradient(45deg, transparent 52%, rgba(243, 4, 136, 0.8) 100%);
	border: 2px solid rgba(187, 1, 224, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(142, 9, 231, 0.966);
	background-color: rgba(37, 22, 34, 0.701);
}
...
#app-mount .app-2rEoOp {
	background: url(https://i.imgur.com/HV72bjq.jpg) 30%/cover;
}
...
.theme-dark .quickswitcher-3JagVE {
	background-image: linear-gradient(45deg, rgba(48, 4, 120, 0.66) 0%, rgba(118, 11, 70, 0.54) 100%), url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
    color: white;
	border: 2px solid rgba(0, 0, 0, 0.66);
	box-shadow: inset 0 0 26px 5px rgba(0, 0, 0, 0.66);
	opacity: 0.8;
}

.settingCard-3w2mVL.active-1ytUzX {
	background-image: linear-gradient(45deg, rgba(74, 4, 120, 0.66) 0%, rgba(118, 11, 86, 0.54) 100%), url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
	border: 2px solid rgba(0, 0, 0, 0.66);
	box-shadow: inset 0 0 26px 5px rgba(0, 0, 0, 0.66);
}
...
.settingCard-3w2mVL {
	background-image: linear-gradient(45deg, rgba(83, 4, 120, 0.66) 0%, rgba(118, 11, 70, 0.54) 100%), url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
	border-radius: 5px;
	border: 2px solid rgba(0, 0, 0, 0.66);
	box-shadow: inset 0 0 26px 5px rgba(0, 0, 0, 0.66);
...
.autocompleteQuerySymbol-1kyGZ5 {
	background-color: rgba(120, 4, 85, 0.66);
	border-radius: 30px;
}
...
.theme-dark .tipsWithoutResults-lGY-De,
.theme-dark .tipsWithResults-HhTE9b {
	border-color: transparent;
	color: white;
}
...
.theme-dark .keybindShortcut-1BD6Z1 span:active {
	background-image: linear-gradient(45deg, rgba(195, 4, 243, 0.8) 100%) 0%, rgba(243, 4, 136, 0.8) 100%) 100%), url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
	border: 2px solid rgba(0, 0, 0, 0.66);
	box-shadow: inset 0 0 6px 1px rgba(0, 0, 0, 0.66);
}

.theme-dark .resultFocused-3aIoYe {
	background-image: linear-gradient(45deg, rgba(93, 4, 120, 0.66) 0%, rgba(118, 11, 73, 0.54) 100%), url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
    color: white;
	border: 2px solid rgba(0, 0, 0, 0.66);
	box-shadow: inset 0 0 26px 5px rgba(0, 0, 0, 0.66);
...
.channel-2QD9_O, .channel-2QD9_O a {
	color: white;
}
...
.clickable-1JJAn8[href*="/activity"]:hover .layout-2DM8Md .avatar-3uk_u9::after,
.clickable-1JJAn8[href*="/library"]:hover .layout-2DM8Md .avatar-3uk_u9::after,
.clickable-1JJAn8[href*="/store"]:hover .layout-2DM8Md .avatar-3uk_u9::after,
.clickable-1JJAn8[href^="/channels/"]:hover .layout-2DM8Md .avatar-3uk_u9::after {
	content: "";
	background-image: url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
	padding: 23px 24px;
	margin-left: -36px;
	margin-right: -9px;
...
.theme-dark .topPill-30KHOu .themed-OHr7kt.item-PXvHYJ:hover {
	background-image: linear-gradient(45deg, rgba(74, 4, 120, 0.66) 0%, rgba(118, 11, 61, 0.54) 100%), url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
	opacity: 0.65;
}
.theme-dark .topPill-30KHOu .themed-OHr7kt.selected-3s45Ha.item-PXvHYJ, 
.theme-dark .topPill-30KHOu .themed-OHr7kt.selected-3s45Ha.item-PXvHYJ:hover,
...
.footer-3rDWdC .input-cIJ7To .lookFilled-1Gx00P.colorBrand-3pXr91,
.copyButton-1I8hd3 {
	border-radius: 0 13px 13px 0 !important;
}
.inputWrapper-31_8H8 .input-cIJ7To .multiInputLast-1aQ3YA input {
	border-radius: 0 13px 13px 0;
}

.inputWrapper-31_8H8 .input-cIJ7To {
...
.tabBar-ZmDY9v .item-3HknzM[style*="background-color: rgba(187, 1, 224, 0.6); color: rgba(187, 1, 224, 0.6);"],
.tabBar-ZmDY9v .item-3HknzM[style*="background-color:rgba(187, 1, 224, 0.6)); color: rgba(187, 1, 224, 0.6));"] {
	background-image: linear-gradient(45deg, rgba(187, 1, 224, 0.6)) 0%, rgba(187, 1, 224, 0.6)) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	background-size: cover;
	color: white !important;
	opacity: 1 !important;
}
...
.theme-dark .popout-13LQ_3 {
  background-image: linear-gradient(45deg, rgba(58, 4, 120, 0.66) 0%, rgba(118, 11, 82, 0.54) 100%), url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
}
...
.container-UC8Ug1 {
	border-radius: 4px;
	border: 1px solid rgba(120, 4, 91, 0.66);
...
.theme-dark .title-30qZAO {
	color: white;
}


.theme-dark .peopleListItem-2nzedh,
...
/* Home button and some of chat with settings */
.theme-dark .peopleListItem-2nzedh:hover {
 background-image: linear-gradient(5deg, rgba(74, 4, 120, 0.66) 0%,rgba(118, 11, 61, 0.54)) 100%), url(https://i.imgur.com/HV72bjq.jpg);
 background-size: cover;
}
.homeIcon-tEMBK1{
	display: none;
...
.theme-dark .childWrapper-anI2G9 {
	background-color: transparent !important;
	background-image: url(https://i.imgur.com/WTtIcFm.jpg);
	background-size: cover;
}
...
.theme-dark .checked-3_4uQ9 path[fill] {
	fill: white;
}
...
.lookOutlined-3sRXeN.colorRed-1TFJan {
	color: white !important;
	border-color: #7600fc !important;
	background-color: #a70772;
}

.side-8zPYf6 .item-PXvHYJ[style*="color: rgb(240, 71, 71);"],
.lookFilled-1Gx00P.colorRed-1TFJan {
	background-image: linear-gradient(45deg, rgba(118, 0, 252, 0.66) 0%rgba(252, 0, 126, 0.54)4) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	background-size: cover;
	color: white !important;
}
...
.lookInverted-2D7oAl.colorGreen-29iAKY {
	background-image: linear-gradient(45deg, rgba(141, 58, 189, 0.797) 0%, rgba(189, 58, 161, 0.811) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	background-size: cover;
	color: white;
}
...
.lookOutlined-3sRXeN.colorGreen-29iAKY {
	color: white;
	border-color: #551f82;
	background-color: #480e2b;
}

.buttonInvertedPurple-WtBglX {
	background-image: linear-gradient(45deg, rgba(102, 71, 198, 0.797) 0%, rgba(198, 71, 145, 0.811) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	color: white;
}

.lookFilled-1Gx00P.colorBrand-3pXr91,
.lookInverted-2D7oAl.colorBrand-3pXr91 {
	background-image: linear-gradient(45deg, rgba(47, 13, 74, 0.797) 0%, rgba(74, 13, 38, 0.811) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	background-size: cover;
	color: white;
}
...
.lookOutlined-3sRXeN.colorBrand-3pXr91 {
	color: white !important;
	border-color: #240d4a !important;
	background-color: #71174e !important;
}

.lookFilled-1Gx00P.button-38aScr, 
.lookInverted-2D7oAl.button-38aScr,
.lookOutlined-3sRXeN.button-38aScr {
   border-radius: 16px;
}

/* This is mostly Chat Section */
...
.guildsError-b7zR5H,
.theme-dark .guildIconUnavailable-5PMHDN  {
	color: white;
	background: linear-gradient(5deg, transparent 42%, rgba(188, 48, 230, 0.989) 100%);
	border: 2px solid rgba(230, 48, 148, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(230, 48, 160, 0.6);
}

.guildsError-b7zR5H:hover {
	background: linear-gradient(5deg, transparent 42%, rgba(124, 10, 218, 0.989) 100%);
	border: 2px solid rgba(157, 48, 230, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(230, 48, 118, 0.6);
}

.theme-dark .tooltipRed-8-9NeP {
	color: white;
	background: linear-gradient(5deg, transparent 42%, rgba(117, 16, 184, 0.989) 100%);
	border: 2px solid rgba(137, 17, 53, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(89, 17, 137, 0.6);
	background-color: rgba(138, 8, 62, 0.56);
}
...
.unreadPillCapStroke-7rkHbg {
  color: rgba(19, 2, 36, 0.843);
  fill: rgba(37, 3, 22, 0.843);
}

.theme-dark .form-2fGMdU:before,
.separator-42rNt0 {
  background: url(https://i.imgur.com/HV72bjq.jpg);
}
...
.theme-dark .cardPlaceholder-1zrbbe {
	background-image: linear-gradient(45deg, rgba(83, 4, 120, 0.66) 0%, rgba(118, 11, 65, 0.54) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
}
...
.bd-switch {
	background-color: rgba(241, 146, 226, 0.19);
	border-radius: 30px;
}

.container-3auIfb {
	border-radius: 30px;
	background-color: rgba(222, 149, 245, 0.19) !important;
}
...
.container-3auIfb[style*="background-color: rgb(67, 181, 129);"] {
	background-image: linear-gradient(45deg,rgba(74, 4, 120, 0.66)  20%, rgba(118, 11, 61, 0.54) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	background-size: 90px;
}
.container-3auIfb[style*="background-color: rgba(118, 11, 77, 0.54);"] rect {
	fill: #8211df;
	rx: 10;
}
.container-3auIfb[style*="background-color: rgba(118, 11, 77, 0.54);"] path {
	fill: white;
}
...
.border-Jn5IOt.voice-3bPYC-.speaking-B2MXPi {
	border-radius: 90%;
    box-shadow: inset 0 0 82px 1px rgba(226, 204, 246, 0.97);
}
...
.border-Jn5IOt {
	border: 4px solid rgba(246, 204, 230, 0.97);
}
...
/* This is to hide offline memebers*/

.offline-3nJYBR{
	display: none;
}
/* Back to editing voice*/
...
.members-1998pB .selected-aXhQR6 .layout-2DM8Md {
	background: linear-gradient(5deg, transparent 52%, rgba(243, 4, 136, 0.8) 100%);
	border: 2px solid rgba(187, 1, 224, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(142, 9, 231, 0.966);
	background-color: rgba(37, 22, 34, 0.701);
...
.wrapper-2jXpOf.modeLocked-SZJhTy:hover .content-1x5b-n {
	background: linear-gradient(5deg, transparent 52%, rgba(243, 4, 136, 0.8) 100%);
	border: 2px solid rgba(187, 1, 224, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(142, 9, 231, 0.966);
	background-color: rgba(37, 22, 34, 0.701);
...
.button-14-BFJ {
	...
	border: 2px solid rgba(187, 1, 224, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(142, 9, 231, 0.966);
	background-color: rgba(2, 0, 1, 0.966);
}
...
.inspector-S2gM3e {
	background: url(https://i.imgur.com/HV72bjq.jpge);
}
...
.navButtonActive-1MkytQ.active {
	background-color: rgba(246, 204, 233, 0.82) !important;
	color: black;
}
...
.navButtonActive-1MkytQ:hover {
	background-color: rgba(246, 204, 225, 0.33);
}
...
.theme-dark .inviteRow-2L02ae:hover {
	background-color: rgba(136, 14, 236, 0.13);
}

.reaction-1hd86g {
   background-color: rgba(148, 10, 228, 0.327);
   border-radius: 30px;
}
...
.itemBase-tz5SeC {
	...
	border-radius: 10px;
	font-weight: bold;
	text-shadow: 0 0 16px white,0 0 16px white;
}
...
.theme-dark .bar-2Qqk5Z[style*="background: rgba(142, 9, 231, 0.966));"] {
	background: rgba(255, 255, 255, 0.39) !important;
}
  
.barFill-23-gu- {
	background: rgba(183, 86, 143, 0.82);
}

.barFill-23-gu-[style*="background: rgba(142, 9, 231, 0.966));"] {
	background: rgba(142, 9, 231, 0.966)) !important;
}

.theme-dark .guildName-3WI6ml, 
.theme-dark .override-2YgiXd, 
.theme-dark .overrideHighlight-YPcBxt {
	color: white;
}
...
.option-3KoAJB[aria-selected=true] {
	color: white;
	background-color: rgba(132, 65, 102, 0.759) !important;
}
...
.iconBadge-qZ4Ksk {
  background-color: rgba(132, 65, 96, 0.576) !important;
  background-image: url(https://i.imgur.com/HV72bjq.jpg);
  background-size: cover;
  width: 14px;
  height: 14px;
...
.theme-dark .jumpToPresentBar-G1R9s6, .container-2fRDfG {
    background-color: rgba(111, 65, 132, 0.7) !important;
}
 
.theme-dark .newMessagesBar-265mhP {
    border-radius: 0 0 11px 11px;
    background-color: rgba(116, 65, 132, 0.7) !important;
}
...
.theme-dark .hasMoreButton-1MELpI {
 background: rgb(94, 65, 132) !important;
 border: none;
}
...
.theme-dark .messageGroupWrapper-o-Zw7G .avatar-1BDn8e {
  margin-top: 2px;
}

.searchResultsWrap-3-pOjs .avatar-1BDn8e {
	margin-top: 2px;
}
...
.cozy-3raOZG .header-23xsNx {
	text-shadow: 0 0 10px rgba(236, 13, 188, 0.445),0 0 5px rgba(224, 8, 116, 0.541),0 0 25px rgb(221, 11, 109),0 0 25px rgba(252, 9, 142, 0),0 0 25px rgb(230, 20, 185);
}
...
.theme-dark .calendarPicker-2yf6Ci .react-datepicker__navigation.react-datepicker__navigation--next, .theme-dark .calendarPicker-2yf6Ci .react-datepicker__navigation.react-datepicker__navigation--previous {
	border-color: transparent;
	background-color: rgba(132, 65, 93, 0.96);
	border-radius: 30px;
}
...
.theme-dark .channelName-1JRO3C, .searchResult-9tQ1uo {
	color: #fff;
	background: linear-gradient(5deg, transparent 52%, rgba(243, 4, 136, 0.8) 100%);
	border: 2px solid rgba(187, 1, 224, 0.6);
	box-shadow: inset 0 0 6px 1px rgba(142, 9, 231, 0.966);
...
.tab-2j5AEF, .tab-2j5AEF:active, .tab-2j5AEF:hover {
  ...
  .theme-dark .tab-2j5AEF.selected-2LAck8 {
	background-color: rgba(132, 65, 104, 0.46);
  }
  
  .tab-2j5AEF:hover {
	background-color: rgba(111, 65, 132, 0.96);
  }
...
.theme-dark .actionHeader-2CT5c7,
...
.markup-2BOw-j {
	color: rgb(255, 255, 255);
	text-shadow: 0 0 12px black,0 0 16px black,0 0 16px black;
}
.placeholder-P6ptfj, 
...
.mentioned-xhSam7 .avatar-1BDn8e {
	margin-top: 6px;
}
...
.theme-dark .messageContainer-gbhlwo .wrapper-3WhCwL {
	top: .1em;
}
...
.theme-dark .wrapperHover-1GktnT:hover {
	background-color: rgba(132, 65, 115, 0.93);
}
...
.mentioned-xhSam7 .mention {
	...
	font-weight: bold;
	top: 0em;
	color: rgb(197, 130, 169) !important;
}
...
.markup-2BOw-j code {
	font-size: .975rem;
	line-height: 27px;
	background-image: linear-gradient(45deg, rgba(243, 4, 135, 0.137) 20%, rgba(243, 4, 135, 0.048) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	background-size: cover;
	padding: 13px;
	margin-top: 15px;
	color: rgb(245, 6, 205);
	text-shadow: 0 0 15px black,0 0 15px black,0 0 15px black,0 0 15px black,0 0 15px black,
	0 0 15px black;
}
...
.progress-3Rbvu0[style*="background-color:  rgba(243, 4, 136, 0.8);"] {
    background-color: transparent !important;
}

.small-1CUeBa[style*="background-color:  rgba(243, 4, 136, 0.8);"] {
    background-color:  #f018c13d !important; 
}
...
.theme-brand .scrollableContainer-2NUZem {
	background-color: rgba(132, 65, 93, 0.993);
}
...
.theme-dark .uploadModal-2ifh8j .inner-3nWsbo .file-34mY5K .icon-kyxXVr.image-2yrs5j::after {	content: "";	background-image: urlhttps://i.imgur.com/HV72bjq.jpg);	background-size: cover;	padding-right: 124px;	padding-bottom: 114px;	margin-left: -20px;	top: -12px;	left: 6px;	position: relative;	border-radius: 50%;	filter: hue-rotate(90deg) contrast(100%) saturate(100%);
}

.innerAutocomplete-1PN280 {	border-radius: 0 0 25px 25px;
}
...
background: linear-gradient(5deg, transparent 52%, rgba(243, 4, 135, 0.281) 100%);	border: 2px solid rgba(187, 1, 224, 0.6);	box-shadow: inset 0 0 6px 1px rgba(142, 9, 231, 0.966);
background-color: rgba(37, 22, 34, 0.363);
border-radius: 50px;
}
...
.membersGroup-v9BXpm {
	color: white;
	text-shadow: 0 0 14px black,0 0 14px black;;
}

.roleColor-36x_Mz {
    text-shadow: 0 0 14px black,0 0 14px black,0 0 14px black,0 0 14px black,0 0 14px black,0 0 14px black;
}

.activity-2Gy-9S {
	color: white;
	text-shadow: 0 0 14px black,0 0 14px black,0 0 14px black,0 0 14px black
}
...
.bd-toast.toast-success {
    border: 2px solid rgba(246, 204, 229, 0.468);
    box-shadow: inset 0 0 6px 1px rgba(233, 204, 246, 0.523);
	background-color: rgba(176, 53, 129, 0.58);
}
...
/* this edits user popout */
.headerXbox-3G-4PF,
.headerSpotify-zpWxgT,
.topSectionSpotify-1lI0-P,
.topSectionXbox-3fWLjS {
	background: rgba(44, 4, 89, 0.6);
	border-left: 2px solid #9d0d61;
	border-right: 2px solid #5c0d9d;
	border-top: 2px solid #9d0d8a;
	border-radius: 30px 30px 0 0;
}

.headerPlaying-j0WQBV,
.topSectionPlaying-1J5E4n {
	background: rgba(91, 14, 142, 0.6);
	border-left: 2px solid #8e0e72;
	border-right: 2px solid #8e0e63;
	border-top: 2px solid #8e0e72;
	border-radius: 30px 30px 0 0;
}

.headerPlaying-j0WQBV ~ .body-3iLsc4,
.headerPlaying-j0WQBV ~ .bodyInner-245q0L {
	background: rgba(52, 14, 142, 0.7) !important;
	border-left: 2px solid #500e8e;
	border-right: 2px solid #8e0e59;
	border-bottom: 2px solid #500e8e;
	border-radius: 0;
}

.topSectionPlaying-1J5E4n ~ .body-3ND3kc {
	background: rgba(121, 14, 142, 0.7);
	border-left: 2px solid #8e0e34;
	border-right: 2px solid #540e8e;
	border-bottom: 2px solid #8e0e59;
	border-radius: 0 0 30px 30px;
}

.headerPlaying-j0WQBV ~ .body-3iLsc4 ~ .footer-1fjuF6,
.headerPlaying-j0WQBV ~ .bodyInner-245q0L ~ .footer-1fjuF6 { 
    border-left: 2px solid #5f0e8e;
	border-right: 2px solid #460e8e;
	border-bottom: 2px solid #8e0e3f;
	border-radius: 0 0 30px 30px;
	background: rgba(142, 14, 99, 0.8);
}
...
.topSectionStreaming-1Tpf5X {
	background: rgba(103, 4, 181, 0.60);
	border-left: 2px solid #3e026e;
	border-right: 2px solid #3e026e;
	border-top: 2px solid #3e026e;
	border-radius: 30px 30px 0 0;
}

.headerStreaming-2FjmGz ~ .body-3iLsc4,
.headerStreaming-2FjmGz ~ .bodyInner-245q0L {
	background: rgba(103, 4, 181, 0.70) !important;
	border-left: 2px solid #3e026e;
	border-right: 2px solid #3e026e;
	border-bottom: 2px solid #3e026e;
	border-radius: 30pxc;
}

.topSectionStreaming-1Tpf5X ~ .body-3ND3kc {
	background: rgba(103, 4, 181, 0.70);
	border-left: 2px solid #3e026e;
	border-right: 2px solid #3e026e;
	border-bottom: 2px solid #3e026e;
	border-radius: 0 0 30px 30px;
...
.headerStreaming-2FjmGz ~ .body-3iLsc4 ~ .footer-1fjuF6,
.headerStreaming-2FjmGz ~ .bodyInner-245q0L ~ .footer-1fjuF6 { 
    border-left: 2px solid #3e026e;
	border-right: 2px solid #3e026e;
	border-bottom: 2px solid #3e026e;
	border-radius: 0 0 30px 30px;
	background: rgba(103, 4, 181, 0.80); 
}

.root-SR8cQa {
	border-radius: 30px;
	background: linear-gradient(5deg, transparent 62%, rgba(226, 204, 246, 0.633)100%);
    border: 2px solid rgba(245, 5, 117, 0.468);
    box-shadow: inset 0 0 6px 1px rgba(233, 9, 147, 0.523);
	background-color: rgba(132, 65, 104, 0.58);
	background-image: url(https://i.imgur.com/HV72bjq.jpg);
	background-size: cover;
}

.topSectionXbox-3fWLjS ~ .body-3ND3kc,
.topSectionSpotify-1lI0-P ~ .body-3ND3kc {
	background: rgba(89, 4, 46, 0.7);
	border-left: 2px solid #440d9d;
	border-right: 2px solid #500d9d;
	border-bottom: 2px solid #9d0d5c;
	border-radius: 0 0 30px 30px;
}
...
.headerXbox-3G-4PF ~ .body-3iLsc4,
.headerSpotify-zpWxgT ~ .body-3iLsc4,
.headerXbox-3G-4PF ~ .bodyInner-245q0L,
.headerSpotify-zpWxgT ~ .bodyInner-245q0L {
    border-left: 2px solid #9d0d50;
	border-right: 2px solid #9d0d72;
	border-radius: 30px;
	background: rgba(34, 4, 89, 0.8) !important;
}

.headerSpotify-zpWxgT ~ .body-3iLsc4 ~ .footer-1fjuF6,
.headerXbox-3G-4PF ~ .body-3iLsc4 ~ .footer-1fjuF6,
.headerSpotify-zpWxgT ~ .bodyInner-245q0L ~ .footer-1fjuF6,
.headerXbox-3G-4PF ~ .bodyInner-245q0L ~ .footer-1fjuF6 { 
    border-left: 2px solid #9d0d55;
	border-right: 2px solid #9d0d79;
	border-bottom: 2px solid #9d0d50;
	border-radius: 0 0 30px 10px;
	background: rgba(58, 4, 89, 0.8);
}
...
.userPopout-3XzG_A {
	...
	box-shadow:rgba(58, 4, 89, 0.8);
	border-radius: 30px;
	background: url(https://i.imgur.com/HV72bjq.jpg) 80% / cover;
}

.avatarWrapper-3H_478 .wrapper-3t9DeA {
...
/* Discord and Better Discord Settings(Last Part) */ 
...
.secondary-dIudih,
.tertiary-aMXF0g {
	background-image: linear-gradient(45deg, rgba(78, 4, 120, 0.66) 0%, rgba(118, 11, 86, 0.54) 100%), url(https://i.imgur.com/HV72bjq) !important;
  background-size: cover;
	color: white;
}
...
.side-8zPYf6 .item-PXvHYJ[style*="color: rgb(255, 255, 255); background-color:rgba(187, 1, 224, 0.6);"] {
	background: linear-gradient(5deg, transparent 62%, rgba(187, 1, 224, 0.6))100%) !important;
	border: 2px solid rgba(187, 1, 224, 0.6));
	box-shadow: inset 0 0 6px 1px rgba(187, 1, 224, 0.6));
	background-color: rgba(187, 1, 224, 0.6)) !important;
}
...
.theme-dark .nowPlaying-284llR {
	background: linear-gradient(5deg, transparent 62%, rgba(35, 1, 51, 0.633)100%) !important;
	border: 2px solid rgba(149, 7, 243, 0.468);
	box-shadow: inset 0 0 6px 1px rgba(75, 2, 97, 0.523);
	background-color: rgba(193, 31, 131, 0.644) !important;
}
...
.ace-monokai .ace_marker-layer .ace_active-line {
	background-color: rgba(53, 13, 80, 0.2);
}

.container-2Pjhx- {
	color: rgba(68, 16, 88, 0.39);
}
...
/* Links extra color and box-Shadow */

.theme-dark .embedTitleLink-1Zla9e {
	color: #f37dc2!important;
}
.filenameLinkWrapper-1-14c5 {
  ...
  .colorStandard-2KCXvj a,
	...
	.footerText-2a7NxZ a {
	  color: #fc29fc;
	  text-shadow: 0 4px 4px black,0 4px 4px black,0 4px 4px black,0 4px 4px black,0 4px 4px black,0 0 4px black,0 0 4px black,0 0 4px black,0 0 4px black,0 0 4px black,0 0 4px black;
	}
  ...
  .lookLink-9FtZy-.colorLink-35jkBc:hover .contents-18-Yxp {
	background-image: linear-gradient(0deg,transparent,transparent 1px,#ce2c90 0,#8d2cce 2px,transparent 0);
  }
...
.background-1QDuV2 {
	background-image: linear-gradient(5deg, rgba(88, 46, 116, 0.66) 100%, rgba(138, 45, 118, 0.694) 30%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	background-size: cover;
	border: none;
	border-radius: 70px;
}
.accountList-33MS45, .connection-1fbD7X {
	background-image: linear-gradient(5deg, rgba(94, 46, 116, 0.66) 20%, rgba(138, 45, 96, 0.694) 100%), url(https://i.imgur.com/HV72bjq.jpg) !important;
	background-size: cover;
	border: none;
	border-radius: 45px;
}
...
.connectionHeader-2MDqhu, .integration-3kMeY4 {
	background: none;
}
...
:not([style="opacity: 1; height: 56px; transform: scale(1);"]) > div > .listItemWrapper-3X98Pc > .wrapper-25eVIn:not(.circleButtonMask-2VNJsN){
  ...
  .expandedFolderIconWrapper-1xLaU-{
	background: url(https://i.imgur.com/uinG3R3.jpg) 50% 50%/cover!important;
	filter: blur(0px);
  }
  ...
  .membersWrap-2h-GB4:not(:hover) > div .member-3-YXUe{
	height: 0px;
	overflow: hidden;
	  transition: height .6s;
  }

  .membersWrap-2h-GB4:hover > div .member-3-YXUe{
	height: 42px;
	  transition: height .6s;
  }
  /* Change square avatars to circle*/
